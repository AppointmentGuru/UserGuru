...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_requests__ = __webpack_require__(55);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
  modules: {
    requests: __WEBPACK_IMPORTED_MODULE_2__modules_requests__["a" /* default */]
  }
}));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__API__ = __webpack_require__(54);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AppointmentGuruBackend;
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  install (Vue, options) {
    Vue.prototype.$requeststore = __WEBPACK_IMPORTED_MODULE_0__store__["a" /* default */]
...
const GET = ({ commit, getters }, request) => {
...
const POST = ({ commit, getters }, request) => {
...
const PUT = ({ commit, getters }, request) => {
...
const PATCH = ({ commit, getters }, request) => {
  request = prepareRequest('patch', request)
  makeRequest(commit, getters, request)
  return request.id
}
/* harmony export (immutable) */ __webpack_exports__["d"] = PATCH;


const DELETE = ({ commit, getters }, request) => {
  request = prepareRequest('delete', request)
  makeRequest(commit, getters, request)
  return request.id
}
/* harmony export (immutable) */ __webpack_exports__["e"] = DELETE;


const RETRY = ({ getters, commit }, requestId) => {
...
/* harmony export (immutable) */ __webpack_exports__["f"] = RETRY;


const CANCEL = ({ commit }, requestId) => {
  console.log('cancel')
}
...
class Resource {
  ...
  list (params = {}, tags = []) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0__store__["a" /* default */].dispatch('GET', req)
  }
  create (data, tags = []) {
    let req = this.__getRequest(this.url, {data, tags})
    this.__addDefaultTags(req, 'create')
    return __WEBPACK_IMPORTED_MODULE_0__store__["a" /* default */].dispatch('POST', req)
  }
  get (id, params = {}) {
  ...
  save (id, data, tags = []) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0__store__["a" /* default */].dispatch('PATCH', req)
  }
  cancel (requestId) {}
  retry (requestId) {
    return __WEBPACK_IMPORTED_MODULE_0__store__["a" /* default */].dispatch('RETRY', requestId)
  }
}
...
class API {
  constructor (name, options = {}) {
    this.name = name
    __WEBPACK_IMPORTED_MODULE_0__store__["a" /* default */].commit('BACKEND_CONFIG_INIT', name)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mutations: {
    ['BACKEND_CONFIG_INIT'] (state, backendName) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].set(state.config.backends, backendName, config)
    },
    ['BACKEND_CONFIG_SET_HEADERS'] (state, backendHeaders) {
       // [backendName, headers]
      let backend = backendHeaders[0]
      let headers = backendHeaders[1]
      __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].set(state.config.backends[backend], 'headers', headers)
    },
    ['BACKEND_CONFIG_SET_HEADER'] (state, backendKeyValue) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].set(headers, key, value)
    },
    ['UPDATE_REQUEST'] (state, request) {
      let index = state.index[request.id]
      __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].set(state.requests, index, request)
    },
    ['PUSH_REQUEST'] (state, request) {
      state.requests.push(request)
      let index = (state.requests.length - 1)
      __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].set(state.index, request.id, index)
  ...
  actions: {
    GET: __WEBPACK_IMPORTED_MODULE_1__actions__["a" /* GET */], POST: __WEBPACK_IMPORTED_MODULE_1__actions__["b" /* POST */], PUT: __WEBPACK_IMPORTED_MODULE_1__actions__["c" /* PUT */], PATCH: __WEBPACK_IMPORTED_MODULE_1__actions__["d" /* PATCH */], DELETE: __WEBPACK_IMPORTED_MODULE_1__actions__["e" /* DELETE */], RETRY: __WEBPACK_IMPORTED_MODULE_1__actions__["f" /* RETRY */]
  },
  getters: {
